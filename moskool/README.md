# moskool
[![Released under MIT license.](https://badgen.net/github/license/micromatch/micromatch)](https://github.com/styxlab/moskool/blob/master/LICENSE)
[![moskool npm package version.](https://badgen.net/npm/v/moskool)](https://www.npmjs.org/package/moskool)
...
[![moskool](https://static.gotsby.org/v1/assets/images/jamify-demo.png)](https://styxlab.github.io) 
...
Additional features can be integrated by installing Gatsby themes or plugins. The following plugins have been tested to work with [`moskool`](https://github.com/styxlab/moskool):
...
1. Install this starter by running
    ...
    ```bash
    gatsby new try-ghost https://github.com/styxlab/moskool
    ```
...
Fork `moskool` in GitHub. After logging into Gatsby Cloud make sure Gatsby Cloud has access rights to your forked repository. Select *I already have a Gatsby Site* and then pick *moskool*. Skip integrations. For a first test also skip content keys. The build should start immediately and show the demo site. Provide content keys in order to source in your own content from Ghost CMS.
